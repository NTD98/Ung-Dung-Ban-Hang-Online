...
public class Sever {
    ...
    public static String signup = "http://"+localhost+":80/Sever/signup.php";
    public static String login = "http://"+localhost+":80/Sever/login.php";
    public static String checkuser = "http://"+localhost+":80/Sever/checkuser.php";
}
